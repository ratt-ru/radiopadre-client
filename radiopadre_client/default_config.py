...
DefaultConfig = OrderedDict(
    ...
    DOCKER_IMAGE="osmirnov/radiopadre:1.0pre9",         # change for each release
    ...
    CLIENT_INSTALL_BRANCH="b1.0-pre9", #"b1.0-pre3",                   # change for each release
    ...
    SERVER_INSTALL_BRANCH="b1.0-pre9", #"b1.0-pre3",                   # change for each release
