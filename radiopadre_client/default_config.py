...
DefaultConfig = OrderedDict(
    ...
    DOCKER_IMAGE="osmirnov/radiopadre:1.0pre2",         # change for each release
    CONTAINER_DEBUG=False,
    CONTAINER_DETACH=False,
    CONTAINER_PERSIST=False,
    GRIM_REAPER=True,
    CLIENT_INSTALL_PATH="~/radiopadre-client",
    CLIENT_INSTALL_REPO="https://github.com/ratt-ru/radiopadre-client.git", # change when devel goes public
    CLIENT_INSTALL_BRANCH="b1.0-pre2",                   # change for each release
    CLIENT_INSTALL_PIP="radiopadre-client",
    SERVER_INSTALL_PATH="~/radiopadre",
    SERVER_INSTALL_REPO="https://github.com/ratt-ru/radiopadre.git", # change when devel goes public
    SERVER_INSTALL_BRANCH="b1.0-pre2",                   # change for each release
