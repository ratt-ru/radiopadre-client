...
DefaultConfig = OrderedDict(
    ...
    DOCKER_IMAGE="osmirnov/radiopadre:1.0pre6",         # change for each release
    ...
    CLIENT_INSTALL_BRANCH="b1.0-pre6", #"b1.0-pre3",                   # change for each release
    ...
    SERVER_INSTALL_BRANCH="b1.0-pre6", #"b1.0-pre3",                   # change for each release
    SERVER_INSTALL_PIP="radiopadre==1.0rc6",
    UPDATE=None,
    VERBOSE=0,
    LOG=False,
    TIMESTAMPS=False,
